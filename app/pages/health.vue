...
function onNav(id) {
  if (id === 'health') return
  const routes = { chat:'/session', setup:'/setup', soul:'/soul', chronik:'/chronicle', files:'/vault', maturity:'/maturity', anchor:'/anchor', transfer:'/transfer', export:'/export', peers:'/peers', connect:'/connection', market:'/marketplace', earnings:'/earnings', settings:'/settings', archivar:'/archivar', connections:'/connections', gatekeeper:'/gatekeeper', wallet:'/wallet', agent:'/agent' }
