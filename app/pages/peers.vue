<template>
  <ClientOnly>
    <div v-if="hasSoul" class="app" :class="{ 'drawer-open': drawerOpen, 'is-collapsed': sidebarCollapsed }">
      <SysSidebar route="peers" :soul-meta="soulMeta ? { ...soulMeta, maturity } : null" :collapsed="sidebarCollapsed" :monetization-enabled="monetizationEnabled"
            ...
            <div class="pr-section">
              ...
              <div v-else class="pr-chips">
                <div v-for="peer in connections" :key="peer.soul_id" class="pr-chip" :style="`border-left: 3px solid ${peerTextColor(peer.soul_id)}`">
                  ...
                  <div class="pr-chip-actions">
                    <button v-if="!peer.mutual" class="pr-action" @click="handleRetryHandshake(peer)" :title="$t('peers.btn_retry_title')">
