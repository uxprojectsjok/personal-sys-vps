...
// Gatekeeper-Föderation (Gatekeeper↔Gatekeeper) ist bewusst nicht Teil dieses
// generischen Templates — nur das Wire (Soul→Gatekeeper), das funktioniert
// unabhängig vom Hosting-Modus und node-übergreifend.
...
export function useGatekeeper() {
  ...
  // Gatekeeper-Node gehen, nicht immer relativ an die eigene Origin. Die
  // eigene Herkunft (body.node_url, für die serverseitige Cert-Fernverifikation)
  // kennt der Browser selbst (window.location.origin) — dafür muss niemand
  // die eigene Adresse manuell eintippen.
