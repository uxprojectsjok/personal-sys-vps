 ...
 *
 * Formula:  price = base × (1 + anchor_count × ANCHOR_COEFF + chain_age_days × AGE_COEFF)
...
export default { version: PRICING_VERSION, anchor_coeff: ANCHOR_COEFF, age_coeff: AGE_COEFF, quote_ttl_sec: QUOTE_TTL_SEC }
