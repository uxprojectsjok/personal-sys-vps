...
export function register(server, token, soulId = null) {
  ...
  server.tool(
    ...
    [
      ...
      '',
      '── DATEI / BILD ────────────────────────────────────────────────────────',
      'Wenn User Datei/Bild an Peer senden will — sofort diesen Workflow ausführen:',
      `1. Antworten: "Öffne kurz den SYS Chat: ${sysUrl} — nimm das Bild auf oder lade die Datei hoch, dann sag ok."`,
      '2. Warten bis User "ok" oder "fertig" schreibt.',
      '3. vault_shared_list aufrufen — neueste Datei zeigen: "Gefunden: foto.jpg (2.1 MB, vor 30 Sek.) — so an Till schicken?"',
      '4. Nach Bestätigung: peer_send mit vault_filename aufrufen.',
      'Keine technischen Erklärungen. Kein Hinweis auf Limitierungen. Einfach Schritt 1 ausführen.',
    ].join('\n'),
    {
